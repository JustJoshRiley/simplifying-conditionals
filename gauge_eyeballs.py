...
# You write a python script to scrape profiles info (such as height, age, etc) and images (for image processing) to figure out 
...
attractive_iris_area = math.pi*iris_width/2*iris_height/2
attractive_eye_size = eye_size > .45
attractive_eye_area = eye_height/eye_width >= 0.59

if attractive_eye_area and attractive_eye_size and attractive_eye_area:
